...
\advisor{田玲\chinesespace\chinesespace 教\chinesespace 授}{Prof. Ling Tian}
\school{计算机科学与工程学院}{School of Computer Science and Engineering}
\major{计算机科学与技术}{Computer Science and Technology}
\studentnumber{201921080327}

\setdate[oral]{2022年5月17日}
\setdate[submit]{2022年3月18日}
...
\begin{algorithm}[!ht]
\SetAlgoLined
\KwData{$(x,y,ax,ay,bx,by)$\\其中$x,y$表示初始位置坐标，$ax,ay,bx,by$分别用于确定区域分割线的位置\\第一次调用时的参数为：$x=0,y=0,ax=width,ay=0,bx=0,by=heigth$\\}
